...
const updateTotals = () => {
  ...
  numTasks.innerHTML = `${categoryTasks.length} тапсырма`;
  ...
  categories.forEach((category) => {
    ...
    div.innerHTML = `
                ...
                <div class="content">
                  ...
                  <p>${categoryTasks.length} тапсырма</p>
                </div>
              </div>
              <div class="options">
...
const renderTasks = () => {
  ...
  if (categoryTasks.length === 0) {
    tasksContainer.innerHTML = `<p class="no-tasks">Бұл санатқа тапсырмалар қосылмаған</p>`;
  } else {
